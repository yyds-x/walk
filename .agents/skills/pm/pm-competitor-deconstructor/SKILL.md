...
description_zh: 按策略/功能/体验/增长四维拆解竞品并给出差异化建议。用户要求竞品分析/对标/差距评估时触发。
description_en: Deconstructs competitors across strategy, features, UX, and growth, producing differentiation recommendations. Invoke for competitor analysis and benchmarking.
version: 1.0.0
---
