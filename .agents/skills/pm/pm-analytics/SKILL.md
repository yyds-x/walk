---
name: pm-analytics
description: 从数据现象到产品决策建议与可视化报告。用户要求指标分析、漏斗/留存/归因、分群对比或输出分析报告时触发。
description_zh: |
  ...
  不适用于：纯 BI 看板搭建、纯 SQL 编写、纯数据清洗脚本。
description_en: Turns data signals into actionable PM insights and a visual report. Invoke for KPI analysis, funnel/retention, attribution, cohorts, or analysis reports.
version: 1.0.0
---
